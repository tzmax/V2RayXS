...
extern NSString* const ROUTE_BACKUP_DEFAULT_GATEWAY_V4_KEY;
extern NSString* const ROUTE_BACKUP_DEFAULT_GATEWAY_V6_KEY;
extern NSString* const ROUTE_BACKUP_DEFAULT_INTERFACE_V4_KEY;
extern NSString* const ROUTE_BACKUP_DEFAULT_INTERFACE_V6_KEY;
